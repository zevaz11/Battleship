...
def shipsImages ():
  ...
  destructorRight = destructorRight.resize((60,60))
  destructorUp = destructorRight.rotate(90)
  destructorUp = destructorUp.resize((60,60))
  destructorLeft = destructorRight.rotate(180)
  destructorLeft = destructorLeft.resize((60,60))
  destructorDown = destructorRight.rotate(270)
  destructorDown = destructorDown.resize((60,60))
  #
  ...
  cruceroRight = cruceroRight.resize((60,60))
  cruceroRight2 = cruceroRight2.resize((60,60))
  #
  cruceroUp = cruceroRight.resize((60,60))
  cruceroUp = cruceroUp.rotate(90)
  cruceroUp2 = cruceroRight2.resize((60,60))
  cruceroUp2 = cruceroUp2.rotate(90)
  #
  cruceroLeft = cruceroRight.resize((60,60))
  cruceroLeft = cruceroLeft.rotate(180)
  cruceroLeft2 = cruceroRight2.resize((60,60))
  cruceroLeft2 = cruceroLeft2.rotate(180)
  #
  cruceroDown = cruceroRight.resize((60,60))
  cruceroDown = cruceroDown.rotate(270)
  cruceroDown2 = cruceroRight2.resize((60,60))
  ...
  acorazadoRight = acorazadoRight.resize((60,60))
  acorazadoRight2 = acorazadoRight2.resize((60,60))
  acorazadoRight3 = acorazadoRight3.resize((60,60))
  #
  acorazadoUp = acorazadoRight.resize((60,60))
  acorazadoUp = acorazadoUp.rotate(90)
  acorazadoUp2 = acorazadoRight2.resize((60,60))
  acorazadoUp2 = acorazadoUp2.rotate(90)
  acorazadoUp3 = acorazadoRight3.resize((60,60))
  acorazadoUp3 = acorazadoUp3.rotate(90)
  #
  acorazadoLeft = acorazadoRight.resize((60,60))
  acorazadoLeft = acorazadoLeft.rotate(180)
  acorazadoLeft2 = acorazadoRight2.resize((60,60))
  acorazadoLeft2 = acorazadoLeft2.rotate(180)
  acorazadoLeft3 = acorazadoRight3.resize((60,60))
  acorazadoLeft3 = acorazadoLeft3.rotate(180)
  #
  acorazadoDown = acorazadoRight.resize((60,60))
  acorazadoDown = acorazadoDown.rotate(270)
  acorazadoDown2 = acorazadoRight2.resize((60,60))
  acorazadoDown2 = acorazadoDown2.rotate(270)
  acorazadoDown3 = acorazadoRight3.resize((60,60))
...
def selectShip1(event):
  ...
  if totalShipsPlayer1 < 12:
    if destructorsPlayer1 >= 6:
      messagebox.showinfo("Info","Ya colocó todos los destructores")
    elif keyQ == True:
      messagebox.showinfo("Info","Seleccionaste el destructor")
...
def selectShip2(event):
  ...
  if totalShipsPlayer1 < 12:
    if crucerosPlayer1 >= 4:
      ...
      messagebox.showinfo("Info","Seleccionaste el crucero")
      crucerosPlayer1 += 1
      currentShipKey = shipKeys1[currentShipIndex1] # Posición actual en el diccionario 
      if rotate == 0:
...
def selectShip3(event):
  ...
  if totalShipsPlayer1 < 12:
    if acorazadosPlayer1 >= 2:
      ...
      messagebox.showinfo("Info","Seleccionaste el acorazado")
      acorazadosPlayer1 += 1
      currentShipKey = shipKeys1[currentShipIndex1] # Posición actual en el diccionario 
      if rotate == 0:
...
def shipMovement(event):
  """ La función ShipMovement, es invocada cada vez que sucede el cambio entre rondas, y esta variable se encarga de actualizar la posición de todos los botes.
  """
...
def board(x: int, y: int) -> Tk:
  ...
  game.configure(bg="gray14")
  game.state("zoomed")
  windowWidth = game.winfo_screenwidth()
  windowHeight = game.winfo_screenmmheight()
  game.geometry(f"{windowWidth}x{windowHeight}")
...
def menuJuego():
  ...
  #Título del juego
  tituloJuego = Label(juego, text="BATTLESHIP", background="gray14", fg="cyan", font=('Helvetica bold', 50))
  tituloJuego.place(relx=0.5, rely=0.2, anchor = "center")
  #Botón de partida nueva
  botonPartidaN = Button(juego, text="Nueva Partida", command=lambda:(juego.destroy(), nuevaPartida()))
  botonPartidaN.place(relx=0.5, rely=0.4, anchor = "center", height=50, width=200)
  #Botón de cargar partida
  botonCargarP = Button(juego, text="Cargar partida", command=lambda:(juego.destroy(),cargarPartida()))
  botonCargarP.place(relx=0.5, rely=0.5, anchor = "center", height=50, width=200)
  #Botón de salir
  botonSalir = Button(juego, text="Salir del juego", command = juego.destroy)
